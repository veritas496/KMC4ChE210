function [NZE,HdiffusionSP,CH4DSP,CH3DSP,CH2DSP,CHDSP,CdiffusionSP,C3diffusionSP,H2PSP,CH4PSP,CH3PSP,CH2PSP,CHPSP]=redefineCH4PcheckNB(NZE,Conf,W,L,H,CH3,CH2,CH,C,C3,HdiffusionSP,...
...
if CH3NBup(2)<=L
    ...
    switch (Checkspecies)
        ...
        case(H)
            CH4PSP(CH3pickedup(1),CH3pickedup(2))=CH4PSP(CH3pickedup(1),CH3pickedup(2))-1;
