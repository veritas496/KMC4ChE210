function [NZE,CHDSP,CH2PSP,C2FSP,C3FSP,CXFSP,CdiffusionSP,HdiffusionSP,CH4DSP,H2PSP,CH3DSP,CH2DSP,CH3PSP,CHPSP,C3diffusionSP,CH4PSP]=CHPcheckNB(NZE,Conf,W,L,H,C,C2,C3,...
...
if (CNBup(2)<=L)&sum((CNBup~=Hpickedup).^2)~=0
    ...
    switch (Checkspecies)
        case(0)
            ...
            CdiffusionSP(Cpickedup(1),Cpickedup(2))=CdiffusionSP(Cpickedup(1),Cpickedup(2))-1;%removeevent(CdiffusionSP,x,'CdiffusionSP');
