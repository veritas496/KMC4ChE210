function [NZE,Conf,CHPSP,C2FSP,C3FSP,CXFSP,CdiffusionSP]=CXFcheckCNB(NZE,Conf,W,L,H,C,C2,C3,CX,CHPSP,C2FSP,C3FSP,CXFSP,CdiffusionSP,...
    CX1pickedup,Cpickedup,CNBup,CNBdown,CNBleft,CNBright)
...
if (CNBup(2)<=L)&sum((CNBup~=CX1pickedup).^2)~=0
    ...
    switch (Checkspecies)
        case(0)
            CdiffusionSP(Cpickedup(1),Cpickedup(2))=CdiffusionSP(Cpickedup(1),Cpickedup(2))-1;
