function [NZE,HdiffusionSP,CH4DSP,CH3DSP,CH2DSP,CHDSP,CdiffusionSP,C3diffusionSP,H2PSP,CH4PSP,CH3PSP,CH2PSP,CHPSP]=CH4PcheckNB(NZE,Conf,W,L,H,CH3,CH2,CH,C,C3,HdiffusionSP,...
...
if (CH3NBup(2)<=L)&sum((CH3NBup-Hpickedup).^2)~=0
    ...
    switch (Checkspecies)
        case(0)
            ...
            CH4DSP(CH3NBup(1),CH3NBup(2))=CH4DSP(CH3NBup(1),CH3NBup(2))+1;%addevent(CH4DSP,y,'CH4DSP');
            if CH4DSP(CH3NBup(1),CH3NBup(2))==1
                NZE(5)=NZE(5)+1;
            end
            CH3DSP(CH3pickedup(1),CH3pickedup(2))=CH3DSP(CH3pickedup(1),CH3pickedup(2))-1;%removeevent(CH3DSP,x,'CH3DSP');
            if CH3DSP(CH3pickedup(1),CH3pickedup(2))==0
                NZE(6)=NZE(6)-1;
            end
        case(H)
            HdiffusionSP(CH3NBup(1),CH3NBup(2))=HdiffusionSP(CH3NBup(1),CH3NBup(2))+1;%addevent(HdiffusionSP,y,'HdiffusionSP');
            if HdiffusionSP(CH3NBup(1),CH3NBup(2))==1
                NZE(1)=NZE(1)+1;
            end
        case(CH3)
            CH3DSP(CH3NBup(1),CH3NBup(2))=CH3DSP(CH3NBup(1),CH3NBup(2))+1;%addevent(CH3DSP,y,'CH3DSP');
            if CH3DSP(CH3NBup(1),CH3NBup(2))==1
                NZE(6)=NZE(6)+1;
            end
        case(CH2)
            CH2DSP(CH3NBup(1),CH3NBup(2))=CH2DSP(CH3NBup(1),CH3NBup(2))+1;%addevent(CH2DSP,y,'CH2DSP');
            if CH2DSP(CH3NBup(1),CH3NBup(2))==1
                NZE(7)=NZE(7)+1;
            end
        case(CH)
            CHDSP(CH3NBup(1),CH3NBup(2))=CHDSP(CH3NBup(1),CH3NBup(2))+1;%addevent(CHDSP,y,'CHDSP');
            if CHDSP(CH3NBup(1),CH3NBup(2))==1
                NZE(8)=NZE(8)+1;
            end
        case(C)
            CdiffusionSP(CH3NBup(1),CH3NBup(2))=CdiffusionSP(CH3NBup(1),CH3NBup(2))+1;%addevent(CdiffusionSP,y,'CdiffusionSP');
            if CdiffusionSP(CH3NBup(1),CH3NBup(2))==1
                NZE(3)=NZE(3)+1;
            end
        case(C3)
            C3diffusionSP(CH3NBup(1),CH3NBup(2))=C3diffusionSP(CH3NBup(1),CH3NBup(2))+1;%addevent(C3diffusionSP,y,'C3diffusionSP');   
            if C3diffusionSP(CH3NBup(1),CH3NBup(2))==1
                NZE(4)=NZE(3)+1;
            end
    end
end
...
if (CH3NBdown(2)>=1)&sum((CH3NBdown~=Hpickedup).^2)~=0
    ...
    switch (Checkspecies)
        case(0)
            ...
            CH4DSP(CH3NBdown(1),CH3NBdown(2))=CH4DSP(CH3NBdown(1),CH3NBdown(2))+1;%addevent(CH4DSP,y,'CH4DSP');
            if CH4DSP(CH3NBdown(1),CH3NBdown(2))==1
                NZE(5)=NZE(5)+1;
            end
            CH3DSP(CH3pickedup(1),CH3pickedup(2))=CH3DSP(CH3pickedup(1),CH3pickedup(2))-1;%removeevent(CH3DSP,x,'CH3DSP');
            if CH3DSP(CH3pickedup(1),CH3pickedup(2))==0
        ...
        case(H)
            HdiffusionSP(CH3NBdown(1),CH3NBdown(2))=HdiffusionSP(CH3NBdown(1),CH3NBdown(2))+1;%addevent(HdiffusionSP,y,'HdiffusionSP');
            if HdiffusionSP(CH3NBdown(1),CH3NBdown(2))==1
                NZE(1)=NZE(1)+1;
            end
        case(CH3)
            CH3DSP(CH3NBdown(1),CH3NBdown(2))=CH3DSP(CH3NBdown(1),CH3NBdown(2))+1;%addevent(CH3DSP,y,'CH3DSP');
            if CH3DSP(CH3NBdown(1),CH3NBdown(2))==1
                NZE(6)=NZE(6)+1;
            end
        case(CH2)
            CH2DSP(CH3NBdown(1),CH3NBdown(2))=CH2DSP(CH3NBdown(1),CH3NBdown(2))+1;%addevent(CH2DSP,y,'CH2DSP');
            if CH2DSP(CH3NBdown(1),CH3NBdown(2))==1
                NZE(7)=NZE(7)+1;
            end
        case(CH)
            CHDSP(CH3NBdown(1),CH3NBdown(2))=CHDSP(CH3NBdown(1),CH3NBdown(2))+1;%addevent(CHDSP,y,'CHDSP');
            if CHDSP(CH3NBdown(1),CH3NBdown(2))==1
                NZE(8)=NZE(8)+1;
            end
        case(C)
            CdiffusionSP(CH3NBdown(1),CH3NBdown(2))=CdiffusionSP(CH3NBdown(1),CH3NBdown(2))+1;%addevent(CdiffusionSP,y,'CdiffusionSP');
            if CdiffusionSP(CH3NBdown(1),CH3NBdown(2))==1
                NZE(3)=NZE(3)+1;
            end
        case(C3)
            C3diffusionSP(CH3NBdown(1),CH3NBdown(2))=C3diffusionSP(CH3NBdown(1),CH3NBdown(2))+1;%addevent(C3diffusionSP,y,'C3diffusionSP');   
            if C3diffusionSP(CH3NBdown(1),CH3NBdown(2))==1
                NZE(4)=NZE(3)+1;
            end
    end
end
...
if (CH3NBleft(1)>=1)&sum((CH3NBleft~=Hpickedup).^2)~=0
    ...
    switch (Checkspecies)
        case(0)
            ...
            CH4DSP(CH3NBleft(1),CH3NBleft(2))=CH4DSP(CH3NBleft(1),CH3NBleft(2))+1;%addevent(CH4DSP,y,'CH4DSP');
            if CH4DSP(CH3NBleft(1),CH3NBleft(2))==1
                NZE(5)=NZE(5)+1;
            end
            CH3DSP(CH3pickedup(1),CH3pickedup(2))=CH3DSP(CH3pickedup(1),CH3pickedup(2))-1;%removeevent(CH3DSP,x,'CH3DSP');
            if CH3DSP(CH3pickedup(1),CH3pickedup(2))==0
        ...
        case(H)
            HdiffusionSP(CH3NBleft(1),CH3NBleft(2))=HdiffusionSP(CH3NBleft(1),CH3NBleft(2))+1;%addevent(HdiffusionSP,y,'HdiffusionSP');
            if HdiffusionSP(CH3NBleft(1),CH3NBleft(2))==1
                NZE(1)=NZE(1)+1;
            end
        case(CH3)
            CH3DSP(CH3NBleft(1),CH3NBleft(2))=CH3DSP(CH3NBleft(1),CH3NBleft(2))+1;%addevent(CH3DSP,y,'CH3DSP');
            if CH3DSP(CH3NBleft(1),CH3NBleft(2))==1
                NZE(6)=NZE(6)+1;
            end
        case(CH2)
            CH2DSP(CH3NBleft(1),CH3NBleft(2))=CH2DSP(CH3NBleft(1),CH3NBleft(2))+1;%addevent(CH2DSP,y,'CH2DSP');
            if CH2DSP(CH3NBleft(1),CH3NBleft(2))==1
                NZE(7)=NZE(7)+1;
            end
        case(CH)
            CHDSP(CH3NBleft(1),CH3NBleft(2))=CHDSP(CH3NBleft(1),CH3NBleft(2))+1;%addevent(CHDSP,y,'CHDSP');
            if CHDSP(CH3NBleft(1),CH3NBleft(2))==1
                NZE(8)=NZE(8)+1;
            end
        case(C)
            CdiffusionSP(CH3NBleft(1),CH3NBleft(2))=CdiffusionSP(CH3NBleft(1),CH3NBleft(2))+1;%addevent(CdiffusionSP,y,'CdiffusionSP');
            if CdiffusionSP(CH3NBleft(1),CH3NBleft(2))==1
                NZE(3)=NZE(3)+1;
            end
        case(C3)
            C3diffusionSP(CH3NBleft(1),CH3NBleft(2))=C3diffusionSP(CH3NBleft(1),CH3NBleft(2))+1;%addevent(C3diffusionSP,y,'C3diffusionSP');   
            if C3diffusionSP(CH3NBleft(1),CH3NBleft(2))==1
                NZE(4)=NZE(3)+1;
            end
    end
end
...
if (CH3NBright(1)<=W)&sum((CH3NBright~=Hpickedup).^2)~=0
    ...
    switch (Checkspecies)
        case(0)
            ...
            CH4DSP(CH3NBright(1),CH3NBright(2))=CH4DSP(CH3NBright(1),CH3NBright(2))+1;%addevent(CH4DSP,y,'CH4DSP');
            if CH4DSP(CH3NBright(1),CH3NBright(2))==1
                NZE(5)=NZE(5)+1;
            end
            CH3DSP(CH3pickedup(1),CH3pickedup(2))=CH3DSP(CH3pickedup(1),CH3pickedup(2))-1;%removeevent(CH3DSP,x,'CH3DSP');
            if CH3DSP(CH3pickedup(1),CH3pickedup(2))==0
        ...
        case(H)
            HdiffusionSP(CH3NBright(1),CH3NBright(2))=HdiffusionSP(CH3NBright(1),CH3NBright(2))+1;%addevent(HdiffusionSP,y,'HdiffusionSP');
            if HdiffusionSP(CH3NBright(1),CH3NBright(2))==1
                NZE(1)=NZE(1)+1;
            end
        case(CH3)
            CH3DSP(CH3NBright(1),CH3NBright(2))=CH3DSP(CH3NBright(1),CH3NBright(2))+1;%addevent(CH3DSP,y,'CH3DSP');
            if CH3DSP(CH3NBright(1),CH3NBright(2))==1
                NZE(6)=NZE(6)+1;
            end
        case(CH2)
            CH2DSP(CH3NBright(1),CH3NBright(2))=CH2DSP(CH3NBright(1),CH3NBright(2))+1;%addevent(CH2DSP,y,'CH2DSP');
            if CH2DSP(CH3NBright(1),CH3NBright(2))==1
                NZE(7)=NZE(7)+1;
            end
        case(CH)
            CHDSP(CH3NBright(1),CH3NBright(2))=CHDSP(CH3NBright(1),CH3NBright(2))+1;%addevent(CHDSP,y,'CHDSP');
            if CHDSP(CH3NBright(1),CH3NBright(2))==1
                NZE(8)=NZE(8)+1;
            end
        case(C)
            CdiffusionSP(CH3NBright(1),CH3NBright(2))=CdiffusionSP(CH3NBright(1),CH3NBright(2))+1;%addevent(CdiffusionSP,y,'CdiffusionSP');
            if CdiffusionSP(CH3NBright(1),CH3NBright(2))==1
                NZE(3)=NZE(3)+1;
            end
        case(C3)
            C3diffusionSP(CH3NBright(1),CH3NBright(2))=C3diffusionSP(CH3NBright(1),CH3NBright(2))+1;%addevent(C3diffusionSP,y,'C3diffusionSP');   
            if C3diffusionSP(CH3NBright(1),CH3NBright(2))==1
                NZE(4)=NZE(3)+1;
            end
    end
end
