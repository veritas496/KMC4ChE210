function [NZE,CdiffusionSP,CH2PSP,C2FSP,C3FSP,CXFSP,CHPSP,HdiffusionSP,CH4DSP,H2PSP,CH3DSP,CH2DSP,CH3PSP,CHDSP,C3diffusionSP,CH4PSP]=CHDcheckNB(NZE,Conf,W,L,H,C,C2,C3,...
...
if (CNBup(2)<=L)&sum((CNBup~=Hpickedup).^2)~=0
    Checkspecies=Conf(CNBup(1),CNBup(2)); %check C neighbour
    
    switch (Checkspecies)
        case(0)
            CdiffusionSP(Cpickedup(1),Cpickedup(2))=CdiffusionSP(Cpickedup(1),Cpickedup(2))+1;%addevent(CdiffusionSP,x,'CdiffusionSP');
            if CdiffusionSP(Cpickedup(1),Cpickedup(2))==1
                NZE(3)=NZE(3)+1;
            end
        case(H)
            CHPSP(Cpickedup(1),Cpickedup(2))=CHPSP(Cpickedup(1),Cpickedup(2))+1;%addevent(CHPSP,x,'CHPSP');
            CH2PSP(Cpickedup(1),Cpickedup(2))=CH2PSP(Cpickedup(1),Cpickedup(2))-1;%removeevent(CH2PSP,x,'CH2PSP');
            if CH2PSP(Cpickedup(1),Cpickedup(2))==0
                NZE(17)=NZE(17)-1;
            end
        case(C)
            C2FSP(Cpickedup(1),Cpickedup(2))=C2FSP(Cpickedup(1),Cpickedup(2))+1;%addevent(C2FSP,x,'C2FSP');
            if C2FSP(Cpickedup(1),Cpickedup(2))==1
                NZE(9)=NZE(9)+1;
            end
            C2FSP(CNBup(1),CNBup(2))=C2FSP(CNBup(1),CNBup(2))+1;%addevent(C2FSP,y,'C2FSP');
            if C2FSP(CNBup(1),CNBup(2))==1
                NZE(9)=NZE(9)+1;
            end
        case(C2)
            C3FSP(CNBup(1),CNBup(2))=C3FSP(CNBup(1),CNBup(2))+1;%addevent(C3FSP,y,'C3FSP');
            if C3FSP(CNBup(1),CNBup(2))==1
                NZE(10)=NZE(10)+1;
            end
        case(C3) 
            CXFSP(CNBup(1),CNBup(2))=CXFSP(CNBup(1),CNBup(2))+1;%addevent(CXFSP,y,'CXFSP');
            if CXFSP(CNBup(1),CNBup(2))==1
                NZE(11)=NZE(11)+1;
            end
        case(CX)
            CXFSP(CNBup(1),CNBup(2))=CXFSP(CNBup(1),CNBup(2))+1;%addevent(CXFSP,y,'CXFSP');
...
if (CNBdown(2)>=1)&sum((CNBdown~=Hpickedup).^2)~=0
    ...
    switch (Checkspecies)
        ...
        case(C)
            ...
            C2FSP(CNBdown(1),CNBdown(2))=C2FSP(CNBdown(1),CNBdown(2))+1;%addevent(C2FSP,y,'C2FSP');
            if C2FSP(CNBdown(1),CNBdown(2))==1
                NZE(9)=NZE(9)+1;
            end
        case(C2)
            C3FSP(CNBdown(1),CNBdown(2))=C3FSP(CNBdown(1),CNBdown(2))+1;%addevent(C3FSP,y,'C3FSP');
            if C3FSP(CNBdown(1),CNBdown(2))==1
                NZE(10)=NZE(10)+1;
            end
        case(C3) 
            CXFSP(CNBdown(1),CNBdown(2))=CXFSP(CNBdown(1),CNBdown(2))+1;%addevent(CXFSP,y,'CXFSP');
            if CXFSP(CNBdown(1),CNBdown(2))==1
                NZE(11)=NZE(11)+1;
            end
        case(CX)
            CXFSP(CNBdown(1),CNBdown(2))=CXFSP(CNBdown(1),CNBdown(2))+1;%addevent(CXFSP,y,'CXFSP');
...
if (CNBleft(1)>=1)&sum((CNBleft~=Hpickedup).^2)~=0
    ...
    switch (Checkspecies)
        ...
        case(C)
            ...
            C2FSP(CNBleft(1),CNBleft(2))=C2FSP(CNBleft(1),CNBleft(2))+1;%addevent(C2FSP,y,'C2FSP');
            if C2FSP(CNBleft(1),CNBleft(2))==1
                NZE(9)=NZE(9)+1;
            end
        case(C2)
            C3FSP(CNBleft(1),CNBleft(2))=C3FSP(CNBleft(1),CNBleft(2))+1;%addevent(C3FSP,y,'C3FSP');
            if C3FSP(CNBleft(1),CNBleft(2))==1
                NZE(10)=NZE(10)+1;
            end
        case(C3) 
            CXFSP(CNBleft(1),CNBleft(2))=CXFSP(CNBleft(1),CNBleft(2))+1;%addevent(CXFSP,y,'CXFSP');
            if CXFSP(CNBleft(1),CNBleft(2))==1
                NZE(11)=NZE(11)+1;
            end
        case(CX)
            CXFSP(CNBleft(1),CNBleft(2))=CXFSP(CNBleft(1),CNBleft(2))+1;%addevent(CXFSP,y,'CXFSP');
...
if (CNBright(1)<=W)&sum((CNBright~=Hpickedup).^2)~=0
    ...
    switch (Checkspecies)
        ...
        case(C)
            ...
            C2FSP(CNBright(1),CNBright(2))=C2FSP(CNBright(1),CNBright(2))+1;%addevent(C2FSP,y,'C2FSP');
            if C2FSP(CNBright(1),CNBright(2))==1
                NZE(9)=NZE(9)+1;
            end
        case(C2)
            C3FSP(CNBright(1),CNBright(2))=C3FSP(CNBright(1),CNBright(2))+1;%addevent(C3FSP,y,'C3FSP');
            if C3FSP(CNBright(1),CNBright(2))==1
                NZE(10)=NZE(10)+1;
            end
        case(C3) 
            CXFSP(CNBright(1),CNBright(2))=CXFSP(CNBright(1),CNBright(2))+1;%addevent(CXFSP,y,'CXFSP');
            if CXFSP(CNBright(1),CNBright(2))==1
                NZE(11)=NZE(11)+1;
            end
        case(CX)
            CXFSP(CNBright(1),CNBright(2))=CXFSP(CNBright(1),CNBright(2))+1;%addevent(CXFSP,y,'CXFSP');
...
if (HNBup(2)<=L)&sum((HNBup~=Cpickedup).^2)~=0
...
if (HNBdown(2)>=1)&sum((HNBdown~=Cpickedup).^2)~=0
...
if (HNBleft(1)>=1)&sum((HNBleft~=Cpickedup).^2)~=0
...
if (HNBright(1)<=W)&sum((HNBright~=Cpickedup).^2)~=0
