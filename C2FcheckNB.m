function [NZE,CHPSP,C2FSP,C3FSP,CXFSP,CdiffusionSP,HdiffusionSP,CH4DSP,CH3DSP,CH2DSP,CHDSP,C3diffusionSP]=C2FcheckNB(NZE,Conf,W,L,H,C,C2,CX,CHPSP,C2FSP,C3FSP,CXFSP,...
...
if (C1NBup(2)<=L)&sum((C1NBup~=C2pickedup).^2)~=0
    ...
    switch (Checkspecies)
        case(0)
            CdiffusionSP(C1pickedup(1),C1pickedup(2))=CdiffusionSP(C1pickedup(1),C1pickedup(2))-1;%removeevent(CdiffusionSP,x,'CdiffusionSP');
            if CdiffusionSP(C1pickedup(1),C1pickedup(2))==0
                NZE(3)=NZE(3)-1;
            end
        case(H)
...
if (C2NBup(2)<=L)&sum((C2NBup~=C1pickedup).^2)~=0
    ...
    switch (Checkspecies)
        case(0)
            CdiffusionSP(C2pickedup(1),C2pickedup(2))=CdiffusionSP(C2pickedup(1),C2pickedup(2))-1;%removeevent(CdiffusionSP,x,'CdiffusionSP');
            if CdiffusionSP(C2pickedup(1),C2pickedup(2))==0
                NZE(3)=NZE(3)-1;
            end
