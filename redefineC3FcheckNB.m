function [NZE,CXFSP,C3diffusionSP,HdiffusionSP,CH4DSP,CH3DSP,CH2DSP,CHDSP,CdiffusionSP,CHPSP,C2FSP,C3FSP]=redefineC3FcheckNB(NZE,Conf,W,L,C,C2,C3,CX,CXFSP,C3diffusionSP,H,CH3,...
    CH2,CH,HdiffusionSP,CH4DSP,CH3DSP,CH2DSP,CHDSP,CdiffusionSP,CHPSP,C2FSP,C3FSP,...
    C2pickedup,C2NBup,C2NBdown,C2NBleft,C2NBright,Cpickedup,CNBup,CNBdown,CNBleft,CNBright) 
...
if C2NBup(2)<=L
    ...
    switch (Checkspecies)
        case(0)
            ...
            if C3diffusionSP(C2pickedup(1),C2pickedup(2))==1
                NZE(4)=NZE(4)+1;
            end
        case(C)
